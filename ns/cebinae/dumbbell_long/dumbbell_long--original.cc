...
main (int argc, char *argv[])
{
  ...
  std::string switch_netdev_size = "1p";
  std::string server_netdev_size = "1p";  
...
Ptr<ExponentialRandomVariable> flowTwoRandom = CreateObject<ExponentialRandomVariable>();
flowTwoRandom->SetAttribute("Mean", DoubleValue(0.2)); // Set the mean value for onTime
flowTwoRandom->SetAttribute("Bound", DoubleValue(0.2)); // Set the bound value for onTime

Ptr<ExponentialRandomVariable> flowThreeRandom = CreateObject<ExponentialRandomVariable>();
flowThreeRandom->SetAttribute("Mean", DoubleValue(0.2)); // Set the mean value for onTime
flowThreeRandom->SetAttribute("Bound", DoubleValue(0.2)); // Set the bound value for onTime
...
std::cout << "app_seconds_start2: " << app_seconds_start2 << " flowThreeRandomStart: " << flowThreeRandomStart << std::endl;
  ...
  Config::SetDefault ("ns3::TcpSocket::RcvBufSize", UintegerValue (1 << 21)); // 62914560
  Config::SetDefault ("ns3::TcpSocket::SndBufSize", UintegerValue (1 << 21)); // 41943040
